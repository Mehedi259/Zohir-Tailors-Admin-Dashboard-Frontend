    ...
    <div className="min-h-screen bg-[#F8F9FA] font-sans pb-12">
      ...
      <div className="max-w-md mx-auto px-6">
        ...
        <div className="mt-12 text-center pb-4 space-y-1">
          ...
          <p className="text-gray-500 text-sm mb-4">হালুয়াঘাট, ময়মনসিংহ</p>
          
          <div className="flex items-center justify-center gap-2 text-gray-700 mb-5">
            <span className="font-semibold text-xl tracking-wide">01912113590</span>
            <a href="https://wa.me/8801912113590" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform">
              <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="currentColor" stroke="none" className="text-[#25D366]">
          ...
          <a href="tel:01912113590" className="inline-flex items-center justify-center gap-2 bg-[#F05A28] text-white px-10 py-3 rounded-full font-bold text-lg shadow-md hover:bg-[#D94F23] transition-all hover:shadow-lg active:scale-95">
